...
def get_tts_wav_api(text, top_k=20, top_p=0.6, temperature=0.6):
...
def test_audio_save():
    fs, audio_to_save=get_tts_wav_api("""大家好我是查特
...
def tts():
    ...
    if request.is_json:
        ...
        sample_rate, audio_data = get_tts_wav_api(text, top_k=top_k, top_p=top_p, temperature=temperature)
